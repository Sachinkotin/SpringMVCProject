...
@NamedQuery(name = "findByMallName",query = "select mall from AdminMallDTO mall where mall.name=:mn")
...
//@NamedQuery(name = "updateLoginCountByAdminName",query = "update mall AdminMallDTO mall set mall.loginCount=:lc where mall.adminName=:nm")
